...
(function () {
  ...
  function generateQueryParams() {
    // Try to get values from Slack's boot data
   ...
   */
  async function fetchThreadData(channel, threadTs, token) {
    try {
      if (!token) {
      ...
      // Make request with exact same format as Slack
  ...
  window.fetchSlackThread = fetchThreadData;
